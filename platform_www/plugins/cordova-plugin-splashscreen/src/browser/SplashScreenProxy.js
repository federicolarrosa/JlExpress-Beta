cordova.define(
  ...
  function (require, exports, module) {
    ...
    var bgColor = "#3498db";
    var imageSrc = "/img/logo1_v2_L.png";
    ...
    function readPreferencesFromCfg(cfg) {
      try {
        ...
        splashImageWidth =
          cfg.getPreferenceValue("SplashScreenWidth") || splashImageWidth;
        splashImageHeight =
          cfg.getPreferenceValue("SplashScreenHeight") || splashImageHeight;
        autoHideSplashScreen =
          cfg.getPreferenceValue("AutoHideSplashScreen") ||
          autoHideSplashScreen;
        autoHideSplashScreen =
